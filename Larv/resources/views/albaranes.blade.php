        ...
        <div
            ...
            <div
                ...
                <div class="flex-1 flex items-center space-x-2">
                    <h1>
                        <span class="text-gray-800 dark:text-white albaranesSpan">Albaranes</span>
                    </h1>
                </div>
            </div>
            <div
                                ...
                                <div class="py-2 font-light border-b border-gray-200 dark:border-gray-600">
                                    <ul class="space-y-2">
                                        <li class="flex items-center">
                                            <input id="activos" type="radio" name="filtroEstado" value="Activo"
                                        ...
                                        <li class="flex items-center">
                                            <input id="facturados" type="radio" name="filtroEstado" value="Facturado"
                                                class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                            <label for="facturados"
                                                class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Facturados</label>
                                        </li>
                                        <li class="flex items-center">
