...
<head>
    ...
    <title>Solicitud de eliminación rechazada</title>
            ...
            <td class="container"
                ...
                <div class="content"
                    ...
                    <span class="preheader"
                        ...
                        Tu solicitud de eliminación de pieza ha sido rechazada.
                    </span>
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main"
                        ...
                        <tr>
                            <td class="wrapper"
                                ...
                                valign="top">
                                <h1
                                    style="font-family: Helvetica, sans-serif; font-size: 22px; font-weight: bold; margin: 0 0 16px 0; color: #eab308;">
                                    Solicitud de eliminación rechazada</h1>
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                    Hola,</p>
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                    Tu solicitud de eliminación de pieza en el vale <strong>{{ $numVale }}</strong>
                                    ha sido <strong style="color: #eab308;">rechazada</strong> por
                                    <strong>{{ $usuarioRechazo }}</strong>.
                                </p>

                                <div
                                    style="background: #fef3c7; border-left: 4px solid #eab308; padding: 16px; border-radius: 4px; margin-bottom: 24px;">
                                    <p
                                        style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: bold; margin: 0 0 8px 0; color: #92400e;">
                                        Detalles de la pieza:</p>
                                    <p
                                        style="font-family: Helvetica, sans-serif; font-size: 16px; margin: 0; color: #92400e;">
                                ...
                                <p
                                    ...
                                    La pieza permanecerá en el vale. Si consideras que esto es un error o necesitas más
                                    información, por favor comunícate con el área correspondiente.
                                </p>
