...
<head>
    ...
    <title>Nueva solicitud de eliminación</title>
            ...
            <td class="container"
                ...
                <div class="content"
                    ...
                    <span class="preheader"
                        ...
                        Se ha solicitado la eliminación de una pieza en el vale {{ $numVale }}.
                    </span>
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main"
                        ...
                        <tr>
                            <td class="wrapper"
                                ...
                                valign="top">
                                <h1
                                    style="font-family: Helvetica, sans-serif; font-size: 22px; font-weight: bold; margin: 0 0 16px 0; color: #dc2626;">
                                    Nueva solicitud de eliminación de pieza</h1>
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                    Hola,</p>
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                    <strong>{{ $usuarioSolicita }}</strong> ha solicitado la eliminación de una pieza en
                                    el vale <strong>{{ $numVale }}</strong>.
                                </p>

                                <div
                                    style="background: #fee2e2; border-left: 4px solid #dc2626; padding: 16px; border-radius: 4px; margin-bottom: 24px;">
                                    <p
                                        style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: bold; margin: 0 0 8px 0; color: #7f1d1d;">
                                        Detalles de la pieza solicitada para eliminación:</p>
                                    <p
                                        style="font-family: Helvetica, sans-serif; font-size: 16px; margin: 0; color: #7f1d1d;">
                                        <strong>Número de parte:</strong> {{ $numeroParte }}<br>
                                        <strong>Descripción:</strong> {{ $descripcionPieza }}
                                    </p>
                                </div>

                                @if (!empty($motivo))
                                    <div
                                        style="background: #f3f4f6; border-left: 4px solid #6b7280; padding: 16px; border-radius: 4px; margin-bottom: 24px;">
                                        <p
                                            style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: bold; margin: 0 0 8px 0; color: #374151;">
                                            Motivo especificado:</p>
                                        <p
                                            style="font-family: Helvetica, sans-serif; font-size: 16px; margin: 0; color: #374151; font-style: italic;">
                                            "{{ $motivo }}"
                                        </p>
                                    </div>
                                @endif
                                ...
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 24px;">
                                    Por favor, revisa la solicitud y toma la acción correspondiente (aprobar o rechazar
                                    la eliminación).
                                </p>
                                                        ...
                                                        <tr>
                                                            <td style="font-family: Helvetica, sans-serif; font-size: 16px; vertical-align: top; border-radius: 4px; text-align: center; background-color: #0867ec;"
                                                                ...
                                                                <a href="{{ $linkVale }}" target="_blank"
                                                                    ...
                                                                    Ver vale y gestionar solicitud
                                                                </a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                ...
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-top: 16px; color: #6b7280;">
                                    <strong>Nota:</strong> Esta solicitud quedará pendiente hasta que sea aprobada o
                                    rechazada. La pieza aparecerá marcada visualmente en el vale.
                                </p>
                            </td>
                        </tr>
                            ...
                            <tr>
                                <td class="content-block"
                                    ...
                                    <span class="apple-link"
                                        ...
                                        © {{ date('Y') }} GestionSiniestros | Uso interno | Favor de no contestar
                                        este correo
                                    </span>
                                </td>
                            </tr>
